        ...
        <div class="space-y-8">
          <div v-for="yearGroup in committeesStore.participationsByYear" :key="yearGroup.year" class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4">
              <div
v-for="participation in yearGroup.participations" :key="`${participation.conference}-${participation.year}`" 
                ...
                <a
:href="participation.url" target="_blank" rel="noopener noreferrer" 
